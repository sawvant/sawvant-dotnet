...
[assembly: InternalsVisibleTo("Sawvant.Test")]
...
namespace Sawvant.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is CutDirection cutDirection)
                return CutDirectionValueConverter.ToJsonValue(cutDirection);
            if (obj is GrainDirection grainDirection)
                return GrainDirectionValueConverter.ToJsonValue(grainDirection);
            if (obj is JobResponse.StatusEnum jobResponseStatusEnum)
                return JobResponse.StatusEnumToJsonValue(jobResponseStatusEnum);
            if (obj is OptimizeRequest.StrategyEnum optimizeRequestStrategyEnum)
                return OptimizeRequest.StrategyEnumToJsonValue(optimizeRequestStrategyEnum);
            if (obj is RateLimitError.StrategyEnum rateLimitErrorStrategyEnum)
                return RateLimitError.StrategyEnumToJsonValue(rateLimitErrorStrategyEnum);
        ...
        /// </summary>
        public const string BASE_ADDRESS = "https://api.sawvant.com";
        ...
        /// The host of the API
        /// </summary>
        public const string HOST = "api.sawvant.com";
